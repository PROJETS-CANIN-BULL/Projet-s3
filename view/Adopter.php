...
<body>
    <header>
      <div class ="row">
        ...
        <nav>
        <ul id="menu">
            <li><a href="../view/accueil.php">><img src="insérer l'emplacement de l'image ici" title="logo" alt="logo"></a></li>
