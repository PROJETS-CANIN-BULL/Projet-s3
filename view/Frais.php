                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <li><a class="dropdown-item"
                                                   href="index.php?action=trierFacturesTypes">A-Z</a></li>
                                            <li><a class="dropdown-item"
                                                   href="index.php?action=trierFacturesTypesDecroissants">Z-A</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item dropdown">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <li><a class="dropdown-item"
                                                   href="index.php?action=trierFacturesDateFactures">Croissant</a></li>
                                            <li><a class="dropdown-item"
                                                   href="index.php?action=trierFacturesDateFacturesDecroissants">Decroissant</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-item dropdown">
